        ...
        <MainContainer>
            ...
            <div className='flex flex-col gap-5 mt-10 w-full'>
                <nav className='flex gap-5 w-full justify-between items-center'>
                    <Link to={"/"} className='text-white bg-amber-800 px-10 py-2 flex flex-1 justify-center'>Home</Link>
                    ...
                    <Link to={"/logout"} className='text-white bg-amber-800 px-10 py-2 flex flex-1 justify-center'>Logout</Link>
                </nav>
                <div className='mt-5'>
                    {children}
                </div>
